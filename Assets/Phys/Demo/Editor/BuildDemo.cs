...
namespace Phys.Demo.Editor
{
    ...
    /// [-buildScene Demo|Castle|Preview|Siege] [-buildPath C:/out/Demo.exe] [-buildDev]. Menu: Phys / Build Demo Player, Build Castle Player,
    ...
    public static class BuildDemo
    {
        ...
        static void BuildPlayer(string scene)
        {
            ...
            bool development = Array.IndexOf(args, "-buildDev") >= 0;   // a development build: the Profiler and the bench's GPU samples work
