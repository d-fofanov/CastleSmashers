...
// World position and normal of a mesh vertex of the given instance. Retired slots (flag bit 4, FLAG_DEAD) and the terrain
// slot (bit 7, FLAG_TERRAIN) collapse to a point so that they rasterise nothing.
